...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "aakarshkashyap42@gmail.com",
    href: "mailto:aakarshkashyap42@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/aakarsh-devulapally-b09a10345/",
    content: "/aakarsh-devulapally-b09a10345",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/AakarshKashyap",
    content: "/AakarshKashyap",
            ...
            <div className="flex flex-row lg:flex-col items-center">
              <div className="flex justify-center items-center lg:w-full lg:aspect-square bg-zinc-800 rounded-xl lg:mb-5">
                <img
                  ...
                  alt="me"
                  src="" // TODO: Add your profile picture in public/assets/me.jpg
                />
              </div>
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Aakarsh Kashyap</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Aakarsh Devulapally, a Fullstack developer passionate about
